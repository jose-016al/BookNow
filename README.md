...
```
4. Genera la estructura de la base de datos y carga los datos de prueba utilizando las migraciones de Doctrine.
```bash
php bin/console doctrine:schema:create
```
5. Inicia el servidor local utilizando el siguiente comando.
```bash
symfony server:start
```
6. Abre tu navegador web y accede a la URL http://localhost:8000 para visualizar el blog de BookNow.